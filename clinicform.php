      ...
      <div class="F-content my-5 ">
         ...
         <div class="form-row">
            <div class="form-group col-md-12">
               ...
               <input type="text" class="form-control" name="clinicName" placeholder="Name">
            </div>
         </div>
         <div class="form-row">
            <div class="form-group col-md-12">
               <label for="inputEmail4">Address</label>
               <input type="text" class="form-control" name="clinicAddress"  placeholder="Apartment, studio, or floor">
            </div>
         </div>
         <div class="form-group">
            <label for="inputAddress2">Telephone Number</label>
            <input type="text" class="form-control" name="clinicPhone"  placeholder="Number">
         </div>
         <div class="form-group">
