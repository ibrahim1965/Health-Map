         ...
         <div class="container">
            ...
            <div class="row">
               <div class="col-md-8 offset-md-2 text-left align-items-center d-flex o-desc">
                  <div class="e-h2-styling">
                     <!--starting title div-->
                     <h1 class="font-weight-bolder pt-2">Welcome, </h1>
                     <h2 >Address:    <small class="o-address-o text-center"><?php echo $hospital['HospitalAddress']; ?></small></h2>
                     <!--Hospital address-->
                     <h2 >Phone:    <small class="o-address-o text-center"><?php echo $hospital['HospitalPhone']; ?></small></h2>
                     <!--Hospital phone no-->
                     <h2 >Working Hours:    <small class="o-address-o text-center"><?php echo $hospital['HospitalWorkingHour']; ?></small></h2>
                  ...
                  <!--button for adding more sections that will href to addsec.html-->
               </div>
               <!--ending title div-->
            </div>
         </div>
